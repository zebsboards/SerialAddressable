...
namespace DirectOutput.Cab.Out.AdressableLedStrip
{
    ...
    public class ZBSerial : OutputControllerCompleteBase
    {
        ...
        protected override void UpdateOutputs(byte[] OutputValues)
        {
            ...
            for (int i = 0; i < 8; i++)  // loop for number of strips
            {
        ...
        protected override void ConnectToController()
        {
            ...
            {
                Log.Write($"********** Setup of ZBSerial Controller Successfully Completed ********** Attempting to start Serial Updater Thread *********");
            }
        }
